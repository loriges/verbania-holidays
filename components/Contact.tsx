...
export default function Contact({ t }: { t: ContactT }) {
  return (
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-playfair text-4xl md:text-5xl text-navy mb-6 leading-tight">
              {t.title}
            </h2>
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-gold flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-navy-dark" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="font-playfair text-navy text-base break-all">{t.email}</p>
              </div>
              <svg className="w-5 h-5 text-gold flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
              </svg>
